...
TODO: обновить инструкицю с библитекой libpqxx для C++20.
...
```bash 
git clone https://github.com/username/employee_app.git
cd employee_app
```
...
| 4 | Автоматическая генерация 1,000,000 сотрудников и 100 с фамилией на "F" | `./myApp 4` |
| 5 | Выборка сотрудников мужского пола с фамилией на "F" и замер времени | `./myApp 5` |
| 6 | Оптимизация запросов и сравнение времени выполнения | `./myApp 6` |
...
Если нужно, вы можете изменить их в файле `.env` перед сборкой или запуском.
